...
- narration은 성우가 소리 내어 읽는 문장이니, 실제 사람이 말하듯 자연스러운 구어체로 써. 친근한 '해요체'를 기본으로 하고(예: "~있어요", "~된대요", "~챙기세요"), 딱딱한 문어체나 어색한 번역투(예: "~을 통해", "~에 의해", "~라 할 수 있다")는 쓰지 마. 쉼표로 자연스러운 호흡을 넣어 읽기 편하게. 후킹(scene1)은 짧게, 본문(scene2~7)은 한두 문장으로 정보를 구체적으로(공백 포함 대략 30~60자). 실제 수치·기관·날짜 등 구체성을 살려 풍부하게.
