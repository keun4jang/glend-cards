...
- 카드2(분석): 소제목(2줄, 한 줄 6자 이내) + 본문 3줄. 구체적 사실/배경/숫자를 충실하게. 각 줄 13~16자.
- 카드3(통찰): 소제목(2줄, 한 줄 6자 이내) + 본문 3줄. 시사점/전망/행동제안을 충실하게. 각 줄 13~16자. 마지막 줄은 반드시 독자에게 행동을 촉구하는 문장 (예: "<b>지금</b> 포트폴리오 점검하세요", "<b>저장</b>하고 다시 보세요").
...
- 인스타 캡션: 아래 구조를 반드시 지켜:
  ...
  3) 저장/공유 유도: "💾 나중에 꺼내볼 수 있게 저장해두세요!" 또는 "📤 경제 공부하는 친구에게 공유해주세요!" 중 하나
