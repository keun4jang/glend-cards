...
- 본문에서 핵심 키워드는 <b>키워드</b>로 감싸 강조 (각 카드당 2~3개). 강조는 반드시 정보를 담은 명사(대상·금액·기한·제도명)만 — 동사·부사·수식어는 강조 금지. <b>태그는 글자수에서 제외해서 셈 것.
...
- query 중요 규칙: 한국 소식을 다루므로 외국인 얼굴이 나오면 어색해. 반드시 사람 얼굴이 안 나오는 사진으로 — 사물(돈, 계산기, 서류), 풍경(도시, 건물, 자연), 손 클로즈업 위주. "person", "man", "woman", "people" 단어 금지.
